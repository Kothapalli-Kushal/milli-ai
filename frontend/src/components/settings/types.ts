...
export type Tab = 'general' | 'models' | 'workspace' | 'memory' | 'agents' | 'orchestrations' | 'fine_tuning' | 'datalab' | 'custom_tools' | 'personal_details' | 'mcp_servers' | 'repos' | 'db_configs' | 'logs' | 'messaging' | 'usage' | 'schedules' | 'import_export' | 'vault' | 'api_keys' | 'scale' | 'support';
